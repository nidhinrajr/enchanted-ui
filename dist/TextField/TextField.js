...
const TextFieldContainer = (0, styles_1.styled)(FormControl_1.default)((theme) => {
    return {
...
const TextField = react_1.default.forwardRef((_a, forwardRef) => {
    ...
    return (react_1.default.createElement(TextFieldContainer, Object.assign({}, muiFormControlProps),
